...
<div class="links"><a class="win" href="{yt}"><span class="w-name">YouTube</span><span class="w-hint">{yt_hint}</span></a><a class="win" href="{sp}"><span class="w-name">Spotify</span><span class="w-hint">{sp_hint}</span></a><a class="win" href="{s["trackViewUrl"].split("&")[0]}"><span class="w-name">Apple Music</span><span class="w-hint">Play this track</span></a><a class="win" href="https://song.link/i/{s['trackId']}"><span class="w-name">Everywhere else</span><span class="w-hint">Deezer, Tidal, Amazon &#8230;</span></a></div>
